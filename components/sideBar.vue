...
<div class="side-bar">
            ...
            <div id="icon-more" class="d-lg-none d-block">
                ...
                <div class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="31.365" viewBox="0 0 36 31.365">
                        <path id="Icon_open-menu" data-name="Icon open-menu" d="M0,0V4.5H36V0ZM0,13.365v4.5H36v-4.5Zm0,13.5v4.5H36v-4.5Z" fill="#41bcd0"/>
                    </svg>
                    ...
                    <li class="col-12">
                          <nuxt-link to="/" class="active">
                            ...
                            <div class="icon-list-right icon-svg-hover me-2">
                               ...
                               <path id="home_3_" data-name="home (3)"
                                     d="M19.48,8.483h0L11.521.525a1.8,1.8,0,0,0-2.54,0L1.029,8.478l-.008.008a1.795,1.795,0,0,0,1.195,3.059l.056,0h.317V17.4a2.1,2.1,0,0,0,2.1,2.1H7.8a.572.572,0,0,0,.571-.571V14.343a.96.96,0,0,1,.959-.959H11.17a.96.96,0,0,1,.959.959v4.591a.572.572,0,0,0,.571.571h3.113a2.1,2.1,0,0,0,2.1-2.1V11.548h.294A1.8,1.8,0,0,0,19.48,8.483Zm-.809,1.73a.649.649,0,0,1-.462.191h-.866a.571.571,0,0,0-.571.571V17.4a.96.96,0,0,1-.959.959H13.271V14.343a2.1,2.1,0,0,0-2.1-2.1H9.334a2.1,2.1,0,0,0-2.1,2.1v4.019H4.69a.96.96,0,0,1-.959-.959V10.977a.571.571,0,0,0-.571-.571H2.283a.652.652,0,0,1-.45-1.114h0L9.79,1.333a.652.652,0,0,1,.923,0l7.955,7.954,0,0a.654.654,0,0,1,0,.922Zm0,0"
                                     transform="translate(-0.5 0.001)" fill="#929292"/>
                           </svg>
  ...
  <g id="Group_84" data-name="Group 84" transform="translate(-3.25 -1.25)">
    <g id="Group_85" data-name="Group 85" transform="translate(3.25 1.25)">
      <path id="Path_55" data-name="Path 55" d="M5.406,8.1a.308.308,0,0,0-.308.308V24.419a.308.308,0,0,0,.308.308H22.651a.308.308,0,0,0,.308-.308V8.406a.308.308,0,0,0-.308-.308ZM3.25,8.406A2.155,2.155,0,0,1,5.406,6.25H22.651a2.155,2.155,0,0,1,2.156,2.156V24.419a2.156,2.156,0,0,1-2.156,2.156H5.406A2.156,2.156,0,0,1,3.25,24.419Z" transform="translate(-3.25 -0.091)" fill="#6a0aa1"/>
      <path id="Path_56" data-name="Path 56" d="M12.985,3.1A3.387,3.387,0,0,0,9.6,6.485V10.8a.924.924,0,0,1-1.848,0V6.485a5.235,5.235,0,1,1,10.47,0V10.8a.924.924,0,0,1-1.848,0V6.485A3.387,3.387,0,0,0,12.985,3.1Z" transform="translate(-2.207 -1.25)" fill="#6a0aa1"/>
    </g>
  </g>
</svg>
  ...
  <defs>
    <clipPath id="clip-path">
      <path id="Path_59" data-name="Path 59" d="M0-682.665H26.419v26.419H0Z" transform="translate(0 682.665)"/>
    </clipPath>
  </defs>
  <g id="Group_89" data-name="Group 89" transform="translate(0 -0.002)">
    <g id="Group_89-2" data-name="Group 89" transform="translate(0 0.002)" clip-path="url(#clip-path)">
      <path id="Path_58" data-name="Path 58" d="M-292.352-201.659a4.059,4.059,0,0,0-4.059,4.059,4.059,4.059,0,0,0,4.059,4.059,4.059,4.059,0,0,0,4.059-4.059A4.059,4.059,0,0,0-292.352-201.659Zm11.393,1.163-1.1.9a2.58,2.58,0,0,0,0,3.984l1.1.9a1.032,1.032,0,0,1,.238,1.313l-2.17,3.759a1.032,1.032,0,0,1-1.256.45l-1.333-.5a2.58,2.58,0,0,0-3.45,1.992l-.234,1.4a1.032,1.032,0,0,1-1.018.862h-4.34a1.032,1.032,0,0,1-1.018-.862l-.234-1.4a2.58,2.58,0,0,0-3.45-1.992l-1.333.5a1.032,1.032,0,0,1-1.256-.45l-2.17-3.759a1.032,1.032,0,0,1,.238-1.313l1.1-.9a2.58,2.58,0,0,0,0-3.984l-1.1-.9a1.032,1.032,0,0,1-.238-1.313l2.17-3.759a1.032,1.032,0,0,1,1.256-.45l1.333.5a2.58,2.58,0,0,0,3.45-1.992l.234-1.4a1.032,1.032,0,0,1,1.018-.862h4.34a1.032,1.032,0,0,1,1.018.862l.234,1.4a2.58,2.58,0,0,0,3.45,1.992l1.333-.5a1.032,1.032,0,0,1,1.256.45l2.17,3.759A1.032,1.032,0,0,1-280.959-200.5Z" transform="translate(305.561 210.809)" fill="none" stroke="#767576" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
    </g>
  </g>
</svg>
                    ...
                    <li class="col-12">
                        <a href="#">
                            <div class="icon-list-right icon-svg-hover me-2">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="19.5" height="19.5" viewBox="0 0 24.783 27.06">
  <g id="Group_88" data-name="Group 88" transform="translate(-17.756)">
    <path id="Path_57" data-name="Path 57" d="M39.928,11.186h-.067V9.545a9.545,9.545,0,0,0-19.089,0v1.641h-.4A2.727,2.727,0,0,0,17.757,14v4.186A2.646,2.646,0,0,0,20.335,20.9h2.513a.636.636,0,0,0,.606-.666q0-.019,0-.038V11.989c0-.4-.234-.8-.6-.8h-.737V9.545a8.205,8.205,0,1,1,16.41,0v1.641h-.737c-.368,0-.6.4-.6.8v8.205a.636.636,0,0,0,.565.7l.038,0h.77l-.067.1a5.291,5.291,0,0,1-4.253,2.11,3.315,3.315,0,0,0-6.564.636,3.349,3.349,0,0,0,3.349,3.315,3.449,3.449,0,0,0,2.411-1.038,2.947,2.947,0,0,0,.8-1.608,6.631,6.631,0,0,0,5.325-2.646l.636-.938A2.28,2.28,0,0,0,42.54,18.52V14.334C42.54,12.894,41.468,11.186,39.928,11.186ZM22.111,19.558H20.369A1.306,1.306,0,0,1,19.1,18.221q0-.018,0-.036V14a1.389,1.389,0,0,1,1.273-1.474h1.741Zm10.348,5.526a1.976,1.976,0,0,1-1.44.636,2.043,2.043,0,0,1-2.009-1.976,1.976,1.976,0,0,1,3.952,0v0a1.775,1.775,0,0,1-.5,1.34ZM41.2,18.52c0,.9-.871,1.038-1.273,1.038H38.521V12.525h1.407c.737,0,1.273,1.038,1.273,1.808Z" transform="translate(0)" fill="#767576"/>
  </g>
</svg>


                            </div>
                            <div class="fs-14">الدعم الفني</div>
                        </a>
                    </li>
                    <li class="col-12">
                        <a href="#">
                            <div class="icon-list-right icon-svg-hover me-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="13.733" height="14" viewBox="0 0 13.733 14">
                                    <path id="Union_144" data-name="Union 144" d="M5.612,14V12.444h6.574V1.556H5.612V0h6.574a1.553,1.553,0,0,1,1.546,1.556V12.444A1.553,1.553,0,0,1,12.187,14ZM0,6.715,3.866,2.826l1.091,1.1-2,2.014h7.477V7.493H2.962l2,2.014L3.866,10.6Z" fill="#929292"/>
                                </svg>

                            </div>
                            <div class="fs-14">تسجيل خروج</div>
                        </a>
                    </li>
                </ul>
            </div>
